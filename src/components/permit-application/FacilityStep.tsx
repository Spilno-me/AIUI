  ...
  return (
    <Card className="w-full max-w-2xl mx-auto">
      <CardHeader className="text-center">
        ...
        <CardDescription>
          Provide details about your facility and its location for permit registration
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleFormSubmit)} className="space-y-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Decimal degrees (e.g., 29.738333)</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Decimal degrees (e.g., -95.168056)</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Regulated Entity Number (RN) *</FormLabel>
                  <FormControl>
                    <div className="relative">
                  ...
                  <FormDescription>Format: RN followed by 9 digits</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
