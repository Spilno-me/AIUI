...
import { EmissionUnitsStep } from './EmissionUnitsStep';
...
const STEPS = [
  { number: 1, title: 'Facility Info', description: 'Location & operator' },
  { number: 2, title: 'Emission Units', description: 'Operations & sources' },
  { number: 3, title: 'Compliance', description: 'Monitoring & requirements' },
  { number: 4, title: 'Summary', description: 'Review & submit' },
] as const;
      ...
      <div className="max-w-4xl mx-auto bg-white/10 dark:bg-black/10 backdrop-blur-sm rounded-2xl border border-white/20 dark:border-white/10 shadow-2xl p-6">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Texas Clean Air Act Compliance Wizard
          </p>
