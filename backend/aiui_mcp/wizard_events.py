"""
Pydantic event models for AI-suggested permit application field values.
...
class CountySuggestionEvent(BaseSuggestionEvent):
    ...
    suggestion: str = Field(..., description="Suggested Texas county")
...
class PrimaryOperationsSuggestionEvent(BaseSuggestionEvent):
    """Event for suggesting primary operations description"""

    event_type: Literal["primary_operations_suggestion"] = "primary_operations_suggestion"
    step: Literal[WizardStep.EMISSION_UNITS] = WizardStep.EMISSION_UNITS
    field_name: Literal["primaryOperations"] = "primaryOperations"
    suggestion: str = Field(..., min_length=20, max_length=500, description="Suggested operations description")
...
class EstimatedEmissionsSuggestionEvent(BaseSuggestionEvent):
    ...
    suggestion: str = Field(..., description="Suggested emission estimate in tons/year")
...
class ComplianceMethodSuggestionEvent(BaseSuggestionEvent):
    ...
    suggestion: ComplianceMethod = Field(..., description="Suggested compliance method")
